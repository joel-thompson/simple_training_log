IntercomRails.config do |config|
  ...
  #
  config.api_secret = Rails.application.secrets.intercom_secret_key
  ...
  config.user.custom_data = {
    ...
    :martial_arts_count => Proc.new { |current_user| current_user.martial_arts.count },
    :lifts_count => Proc.new { |current_user| current_user.lifts.count },
    :lift_choices_count => Proc.new { |current_user| current_user.lift_choices.count },
    :body_weight_records_count => Proc.new { |current_user| current_user.body_weight_records.count },
  }
